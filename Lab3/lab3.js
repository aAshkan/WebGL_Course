//Some part of code comes from perspective.html and cube.html and piazza
var oldX;
var oldY;
var oldZ;
var canvas;
...
function render()
{
    ...
    mvMatrix = lookAt(vec3(radius*Math.sin(theta)*Math.cos(phi), radius*Math.sin(theta)*Math.sin(phi), radius*Math.cos(theta)), vec3(0.0, 0.0, 0.0) , vec3(0.0, 1.0, 0.0));
	document.getElementById("slider").onchange = function(event) {
		zoom = event.target.value;
	};
    pMatrix = perspective(zoom, 3/4, near, far);
